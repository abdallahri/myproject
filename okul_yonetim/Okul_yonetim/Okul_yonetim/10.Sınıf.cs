...
namespace Okul_yonetim
{
    public partial class S10 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'database1DataSet5.Hocalar' table. You can move, or remove it, as needed.
            this.hocalarTableAdapter.Fill(this.database1DataSet5.Hocalar);
            // TODO: This line of code loads data into the 'database1DataSet4.Dersler_10' table. You can move, or remove it, as needed.
            this.dersler_10TableAdapter.Fill(this.database1DataSet4.Dersler_10);
            // TODO: This line of code loads data into the 'database1DataSet3.Ogrenciler_10' table. You can move, or remove it, as needed.
            this.ogrenciler_10TableAdapter.Fill(this.database1DataSet3.Ogrenciler_10);
        ...
        public void Nlistele()
        {
            ...
            baglantı.Open();
            Nadaptor = new SqlDataAdapter("select * from Notlar_10", baglantı);
        ...
        public void Dlistele()
        {
            ...
            baglantı.Open();
            Dadaptor = new SqlDataAdapter("select * from Dersler_10", baglantı);
        ...
        public void Olistele()
        {
            ...
            baglantı.Open();
            adaptor = new SqlDataAdapter("select * from Ogrenciler_10", baglantı);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                komut.CommandText = "INSERT into Ogrenciler_10(OgrNo,Adı,Soyadı,Dtarihi,dyeri,Adres)values('" + txt_OgrNo.Text + "','" + txt_Oadı.Text + "','" + txt_Osoyadı.Text + "','" + txt_ODTarıhı1.Value.ToString() + "','" + txt_DOYEri1.Text + "','" + txt_OAdres1.Text + "')";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                baglantı.Open();
                komut.Connection = baglantı;
                komut.CommandText = "UPDATE Ogrenciler_10 set Adı='" + txt_Oadı.Text + "'," + "Soyadı='" + txt_Osoyadı.Text + "' ," + "Dtarihi='" + txt_ODTarıhı1.Value.ToString() + "' ," + "dyeri='" + txt_DOYEri1.Text + "'," + "Adres='" + txt_OAdres1.Text + "' where OgrNo='" + txt_OgrNo.Text + "'";
                komut.ExecuteNonQuery();
                komut.Dispose();
                baglantı.Close();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cevap == DialogResult.Yes)
                {
                    baglantı.Open();
                    komut.Connection = baglantı;
                    komut.CommandText = "Delete from Ogrenciler_10 where OgrNo=" + txt_OgrNo.Text + "";
                    komut.ExecuteNonQuery();
                    komut.Dispose();
                    baglantı.Close();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            try
            {
                baglantı.Open();
                komut.Connection = baglantı;
                komut.CommandText = "INSERT into Dersler_10(Derskodu,DersAdı,teorik,Uygulama,icerik,Hoca)values('" + txt_derskodu.Text + "','" + txt_dersadı.Text + "','" + txt_Teorik.Text + "','" + txt_uygulama.Text + "','" + txt_icerk.Text + "','" + txt_ders_hoca.SelectedValue + "')";
                komut.ExecuteNonQuery();
                komut.Dispose();
                baglantı.Close();
                MessageBox.Show("Kayıt eklendi..");
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            try
            {
                baglantı.Open();
                komut.Connection = baglantı;
                komut.CommandText = "UPDATE Dersler_10 set DersAdı='" + txt_dersadı.Text + "'," + "teorik='" + txt_Teorik.Text + "' ," + "Uygulama='" + txt_uygulama.Text + "' ," + "icerik='" + txt_icerk.Text + "'," + "Hoca='" + txt_ders_hoca.SelectedValue + "' where Derskodu='" + txt_derskodu.Text + "'";
                komut.ExecuteNonQuery();
                komut.Dispose();
                baglantı.Close();
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (cevap == DialogResult.Yes)
                {
                    baglantı.Open();
                    komut.Connection = baglantı;
                    komut.CommandText = "Delete from Dersler_10 where Derskodu=" + txt_derskodu.Text + "";
                    komut.ExecuteNonQuery();
                    komut.Dispose();
                    baglantı.Close();
                    MessageBox.Show("Kayıt Silindi..");
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                baglantı.Open();
                komut.Connection = baglantı;
                komut.CommandText = "INSERT into Notlar_10(OgrNo,Derskodu,Dersyılı,[1.Dönem Notu],[2.Dönem Notu] , [Yil Sonu Notu])values('" + txt_Notlar_ogrNumrasi.SelectedValue + "','" + txt_notlar_DersKodu.SelectedValue + "','" + txt_dersyılı.Value.ToString() + "','" + txt_1dönem.Text + "','" + txt_2dönem.Text + "','" + s3.ToString() + "')";
                komut.ExecuteNonQuery();
                komut.Dispose();
                baglantı.Close();
                MessageBox.Show("Kayıt eklendi..");
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                baglantı.Open();
                komut.Connection = baglantı;
                komut.CommandText = "UPDATE Notlar_10 set Derskodu='" + txt_notlar_DersKodu.SelectedValue + "'," + "Dersyılı='" + txt_dersyılı.Value.ToString() + "' ," + "[1.Dönem Notu]='" + txt_1dönem.Text + "' ," + "[2.Dönem Notu]='" + txt_2dönem.Text + "'," + " [Yil Sonu Notu]='" + s3.ToString() + "' where OgrNo='" + txt_Notlar_ogrNumrasi.SelectedValue + "'";
                komut.ExecuteNonQuery();
                komut.Dispose();
                baglantı.Close();
            ...
            try
            {
              ...
              MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
                if (cevap == DialogResult.Yes)
                {
                    baglantı.Open();
                    komut.Connection = baglantı;
                    komut.CommandText = "Delete from Notlar_10 where OgrNo=" + txt_Notlar_ogrNumrasi.SelectedValue + "";
                    komut.ExecuteNonQuery();
                    komut.Dispose();
                    baglantı.Close();
                    MessageBox.Show("Kayıt Silindi..");
